 ...
 *           ? const x = new Array(7); console.log(x); =>> giải thích vì sao ra output vậy
 * TODO 2) Giờ tôi muốn điền  
 *           ? giá trị 1 vào arr 'x' 
 *           ? tất cả giá trị của arr là 1
 * TODO 3) Sự khác biệt giữa "map()" và "from()"
 * TODO 4) Viết func để khi nhấn vào ".balance__value" thì sẽ in ra tổng số tiền giao dịch dưới dạng mảng 
 *          ! ví dụ output: [1300, 70, -130, -650, 3000, -400, 450, 200]
 *          ! giả sử b giao dịch thêm (-10) thì lúc đó mảng sẽ như sau [-10, 1300, 70, -130, -650, 3000, -400, 450, 200]
 */
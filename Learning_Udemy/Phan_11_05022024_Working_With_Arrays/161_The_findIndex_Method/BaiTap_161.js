 ...
 * * Giả sử user phát hiện b cướp ny nó, nó không muốn xóa tài khoản của nó khỏi ứng dụng của b
 * * Viết tiếp func trên để hoàn thành những yêu cầu dưới đâu
 * TODO 1) kiểm tra dữ liệu nhập vào có phải là tài khoản đang đăng nhập hay không
 * TODO 2) dùng findIndex để tìm ra vị trí acc hiện tại trong arr "accounts"
 * TODO 3) Xóa tài khoản (lần sau đăng nhập bằng tài khoản đó sẽ k đc nữa)
 * TODO 4) reload lại UI (ẩn UI hiện tại đi)
 * TODO 5) Xóa giá trị mặc định của 2 thẻ input "inputCloseUsername" & "inputClosePin"
 * TODO 6) khi nào use indexOf() & findIndex()
 */
